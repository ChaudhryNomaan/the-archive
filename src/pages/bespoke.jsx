...
const PALETTES = [
  { 
    ...
    name: 'GHOST WHITE', 
    hex: '#F8F8F8', 
    video: '/images/phantom.mp4', // Ensure this file exists in public/images
  ...
  { 
    ...
    name: 'BLACK BADGE', 
    hex: '#0A0A0A', 
    video: '/images/porche.mp4', // Ensure this file exists in public/images
    ...
    <div className="bespoke-root">
      ...
      <section className="config-hero">
        ...
        <div className="visual-viewport">
          <div className={`image-layer ${isChanging ? 'is-syncing' : ''}`}>
            <video
              key={selected.video} // Forces video reload when source changes
              autoPlay
              muted
              loop
              playsInline
              className="car-image" // Kept class name same to preserve your styles
      ...
      <section className="archive-section">
        ...
        <div className="archive-card">
          ...
          {/* <div className="archive-card offset">
            <div className="img-reveal">
              
              <img src="https://images.unsplash.com/photo-1511919884226-fd3cad34687c?q=80&w=800" alt="Veneer" />
            </div>
            <h3>II. RARE VENEERS</h3>
            <p>Hand-selected wood grains, book-matched by master craftspeople to create a symmetrical flow.</p>
          </div> */}

          {/* <div className="archive-card">
            <div className="img-reveal">
              <img src="https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?q=80&w=800" alt="Starlight" />
            </div>
            <h3>III. STARLIGHT HEADLINER</h3>
            <p>1,340 individual fiber-optic lights woven to replicate your specific constellation.</p>
          </div> */}
        </div>
      </section>
      ...
      {/* ... (Your styles remain exactly as they were) ... */}
      <style>{`
        ...
        .archive-card.offset { margin-top: 100px; }
        .img-reveal { height: 500px; overflow: hidden; background: #111; }
        .img-reveal img { width: 100%; height: 100%; object-fit: cover; opacity: 0.6; transition: 1s; }
        ...
        @media (max-width: 1100px) {
          ...
          .archive-card.offset { margin-top: 0; }
        }
      `}</style>
    </div>
  );
